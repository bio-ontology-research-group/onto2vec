...
//Infer subclass axioms using reasoner
...
FileWriter fw= new FileWriter ("axioms.lst",true); BufferedWriter bw =new BufferedWriter (fw); PrintWriter out =new PrintWritter (bw);
FileWriter fw1= new FileWriter ("classes.lst",true); BufferedWriter bw1 =new BufferedWriter (fw1); PrintWriter out1 =new PrintWritter (bw1);
for (OWLClass class1 : classes) {
    Set<OWLClassAxiom> c1axioms=GOOntology.getAxioms (c1);
    allaxioms= renderer.render
    classaxioms=renderer.render (c1axioms);
    out.println (classaxioms);  
    }
